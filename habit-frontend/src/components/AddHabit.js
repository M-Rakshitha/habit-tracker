...
export default function AddHabit({ setIsLoggedIn }) {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center pt-24">
      ...
      <a
        href="/journal"
        className="absolute top-6 left-6 text-sm text-blue-500 hover:text-blue-700"
      >
        Journal & Assistant →
      </a>
          ...
          <div>
            ...
            {completedToday.length === 0 ? (
              ...
              completedToday.map((habit) => (
                ...
                >
                  <p className="text-gray-600 line-through">{habit.name}</p>
                </div>
              ))
            )}
          </div>
          ...
          <div>
            ...
            {missedHabits.length === 0 ? (
              ...
              missedHabits.map((habit) => (
                ...
                >
                  <p className="text-gray-700">{habit.name}</p>
